...
const TRANSLATIONS = {
  ...
  ru: {
    ...
    'tops.hero.sub':   'Лучшие машины по соотношению цена/качество: 65% — рейтинг (динамика, надёжность, комфорт, безопасность), 35% — доступность по цене.',
    ...
    'cars.hero.sub':    'Изучай характеристики и рейтинги каждой машины в каталоге.',
    ...
    'compare.hero.sub':   'Выбери две машины — покажем детальное сравнение всех характеристик.',
    ...
    'quiz.hero.sub':     'Угадай легендарные автомобили по описанию. Проверь, настоящий ли ты автомобилист!',
    'quiz.start.title':  'Готов к испытанию?',
    'quiz.start.body':   '6 вопросов о самых знаковых автомобилях в истории. Угадай марку и модель по описанию.',
    'quiz.rule.1':       '6 вопросов разной сложности',
    'quiz.rule.2':       'По 1 подсказке на вопрос (−10 очков)',
    'quiz.rule.3':       'Таймер 30 секунд — успей ответить',
